...
/**
 * Contains all the static methods related to the Routing object.
 */
  ...
  /**
    ...
    public static function __callStatic($method, $args)
    {
        if (preg_match('/^___dynamic___callback___(.+)___(.+)(___\d+)?/', $method, $matches)) {
            ...
            return RoutingContext::performAction($className, $matches[2], $args);
        } else {
            error_log("\033[31m Strata : Missing static method $method.");
        }
    }
    ...
    public static function kickstart()
    {
        ...
        if ($app && $routes) {
            ...
            error_log("\033[31m Strata : Missing dependencies, will not kickstart.");
        }
    }

    /**
     * Executes a complete calls to the Controller object.
     * @return $mixed Possible data generated by the controller.
     */
